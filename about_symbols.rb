...
class AboutSymbols < Neo::Koan
  ...
  # against the string value rather than against symbols? because can't convert the target string to a symbol to compare to symbols. "converting" the target string to a symbol will create another unique symbol instance
