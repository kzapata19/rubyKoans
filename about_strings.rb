...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # The plus equals operator creates a new string object when it concatenates the target strings whereas the shovel operator appends to the target string without creating another string object
  end
