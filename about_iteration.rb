...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    # Describe in your own words what inject does. Inject reduces an array (or any collection?) of items to one value. Equivalent to JS' reduce method
  end
  ...
  # ANS: if file is wrapped in a block (do/end), the file will be closed once the mapping is complete
