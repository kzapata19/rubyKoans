...
class AboutClassMethods < Neo::Koan
  ...
  # ANS: The second way may be prefered when trying to group all methods so they are organized in a more readable format. The first way may be prefered when there are few methods to define and/or because there is less to type (no need to type "class << self end" wrapper around the method)
  # ------------------------------------------------------------------
