...
class AboutVariableScope < Neo::Koan
  ...
  # ANS: class variable is accessible inside the instance. Instance variable is local to instance object
  # ------------------------------------------------------
...
# ANS: $anywhere is equal to "Hey" since it's also available outside the scope of the class (because its a variable accessible in the global scope)
